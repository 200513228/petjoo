  ...
  Future saveAdvert(BuildContext _) async {
    ...
    await showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              content: const Text(
                  'Uygulamamızda yalnızca hayvanlarla ilgili ürünlerin satışına izin verilmektedir. Kuralları ihlal etmeniz durumunda hesabınız kapatılacaktır. Sağlıklı günler.'),
              actions: [
                ElevatedButton(
